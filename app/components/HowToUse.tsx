        ...
        <div className="bg-white text-black py-20 px-6 md:px-16">
            <div className="max-w-6xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold mb-16 text-center">
                    How to Integrate Our Payment SDK
                </h2>
                        ...
                        <div className="bg-neutral-50 p-8 rounded-lg">
                            ...
                            {activeStep === 2 && (
                                <div>
                                    ...
                                    <p className="mb-4 text-neutral-700">
                                        Ensure that your merchant address in the
                                        SaaS dashboard has a small amount of
                                        USDC already in it. This is crucial as
                                        transactions will fail without prior
                                        USDC balance.
                                    </p>
                                    <div className="bg-white p-6 rounded-lg border border-neutral-200 mb-6">
                                        ...
                                        <p className="text-neutral-600">
                                            Your merchant address must have some
                                            USDC already in it for the system to
                                            work properly. Even a small amount
                                            is sufficient.
                                        </p>
                                    </div>
                                    <div className="bg-neutral-100 p-4 rounded-lg">
                                        <p className="text-sm text-neutral-600">
                                            ...
                                            transaction verification can proceed
                            ...
                            {activeStep === 3 && (
                                <div>
                                    ...
                                    <div className="bg-neutral-100 p-4 rounded-lg">
                                        <p className="text-sm text-neutral-600">
                                            Keep your SaaS ID secure. It will be
                                            used to authenticate your
                            ...
                            {activeStep === 4 && (
                                <div>
                                    ...
                                    <p className="mb-4 text-neutral-700">
                                        Install our payment SDK via npm in your
                                        project directory.
                                    </p>
                                    <div className="bg-black text-white p-6 rounded-lg mb-6 overflow-x-auto">
                                        <code className="text-sm">
                                            npm i @nixblack/nix-payments-sdk
                                        </code>
                                    </div>
                                    <div className="bg-white p-6 rounded-lg border border-neutral-200 mb-6">
                                        <h4 className="font-bold mb-2">
                                        ...
                                        <p className="text-neutral-600 mb-3">
                                            Our SDK is available on npm and can
                                            be accessed at:
                                        </p>
                                        <a
                                            href="https://www.npmjs.com/package/@nixblack/nix-payments-sdk"
                                            target="_blank"
                            ...
                            {activeStep === 5 && (
                                <div>
                                    <h3 className="text-xl font-bold mb-4">
                                        Step 5: Import Create Session
                                    </h3>
                                    <p className="mb-4 text-neutral-700">
                                        Import the createSession function from
                                    ...
                                    <div className="bg-neutral-100 p-4 rounded-lg">
                                        <p className="text-sm text-neutral-600">
                                            The createSession function is the
                                            primary way to start the payment
                            ...
                            {activeStep === 6 && (
                                <div>
                                    <h3 className="text-xl font-bold mb-4">
                                        Step 6: Use the createSession Function
                                    </h3>
                                    <p className="mb-4 text-neutral-700">
                                        Implement the createSession function
                                        with the required parameters to generate
                                        a unique session ID.
                                    </p>
                                    <div className="bg-black text-white p-6 rounded-lg mb-6 overflow-x-auto">
...
// );`}
                                    ...
                                    <div className="bg-white p-6 rounded-lg border border-neutral-200 mb-6">
                                        ...
                                        <ul className="space-y-2 text-neutral-600">
                                            <li>
                                                <strong>saasId</strong>: Your
                                                unique SaaS identifier from the
                                                dashboard
                                            </li>
                                            <li>
                                                <strong>email</strong>
                                            ...
                                            <li>
                                                <strong>plan</strong>
                                                {`: The subscription plan name (e.g., "Premium", "Basic")`}
                                            </li>
                                        </ul>
                                    ...
                                    <div className="bg-neutral-100 p-4 rounded-lg">
                                        <p className="text-sm text-neutral-600">
                                            ...
                                            session ID that will expire after a
                                            set period, so direct the user to
                                            the payment page promptly.
                                        </p>
                                    </div>
                                </div>
                            )}
                            ...
                            {activeStep === 7 && (
                                <div>
                                    <h3 className="text-xl font-bold mb-4">
                                        Step 7: Create a Payment Route
                                    </h3>
                                    <p className="mb-4 text-neutral-700">
                                        Set up a dedicated route in your
                                        application to handle the payment
                                        process using the session ID.
                                    </p>
                                    <div className="bg-black text-white p-6 rounded-lg mb-6 overflow-x-auto">
                                        <pre className="text-sm">
                                            <code>
...
<Link href={\`/payment?sessionId=\${result}\`}>
  Proceed to Payment
                                    ...
                                    <div className="bg-white p-6 rounded-lg border border-neutral-200 mb-6">
                                        ...
                                        <p className="text-neutral-600">
                                            We recommend using a dedicated route
                                            for the payment process rather than
                                            displaying the payment modal on the
                                            same page.
                                        </p>
                                    </div>
                                    <div className="bg-neutral-100 p-4 rounded-lg">
                                        <p className="text-sm text-neutral-600">
                                            This approach provides a cleaner
                                            user experience.
                                        </p>
                                    </div>
                                </div>
                            ...
                            {activeStep === 8 && (
                                <div>
                                    <h3 className="text-xl font-bold mb-4">
                                        Step 8: Implement the Payment Modal
                                    </h3>
                                    <p className="mb-4 text-neutral-700">
                                        On your payment route, import and
                                        implement the PaymentModal component.
                                    </p>
                                    <div className="bg-black text-white p-6 rounded-lg mb-6 overflow-x-auto">
                                        <pre className="text-sm">
                                            <code>
  ...
  return (
    ...
    />
                                    ...
                                    <div className="bg-white p-6 rounded-lg border border-neutral-200 mb-6">
                                        ...
                                        <ul className="space-y-2 text-neutral-600">
                                            <li>
                                                <strong>sessionId</strong>: The
                                                session ID returned from
                                                createSession
                                            </li>
                                            <li>
                                                <strong>RPC_URL</strong>: Your
                                                blockchain RPC URL (preferably a
                                                dedicated one for reliability)
                                            </li>
                                            <li>
                                                <strong>onRedirect</strong>:
                                    ...
                                    <div className="bg-neutral-100 p-4 rounded-lg">
                                        <p className="text-sm text-neutral-600">
                                            While the mainnet RPC URL will work,
                                            we strongly recommend using a
                                            dedicated RPC provider for
                                            production environments to ensure
                                            reliability.
                                        </p>
                                    </div>
                                </div>
                            ...
                            {activeStep === 9 && (
                                <div>
                                    ...
                                    <p className="mb-4 text-neutral-700">
                                        After implementation, all payment
                                        activities will be reflected in your
                                        nixpay dashboard in real-time.
                                    </p>
                                    <div className="bg-white p-6 rounded-lg border border-neutral-200 mb-6">
                                        <h4 className="font-bold mb-2">
                                            Dashboard Features
                                    ...
                                    <div className="bg-neutral-100 p-4 rounded-lg">
                                        <p className="text-sm text-neutral-600">
                                            ...
                                            successful integrations and monitor
                                            your payment flows in production.
                                        </p>
                                    </div>
                                </div>
                            )}
