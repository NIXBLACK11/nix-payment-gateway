        ...
        <div className="min-h-screen bg-white text-black">
            ...
            <nav className="py-4 px-6 md:px-16 border-b border-neutral-200">
                <div className="flex justify-between items-center">
                    <Link href="/">
                        <div className="font-bold text-xl cursor-pointer">nixpay</div>
                    </Link>
                </div>
            </nav>
            ...
            <div className="max-w-4xl mx-auto py-12 px-6">
                ...
                <div className="bg-neutral-50 p-4 rounded mb-8">
                    <p className="text-neutral-700">
                        <strong>Note:</strong> nixpay is currently a proof of concept in development. This privacy
                        policy outlines our intended practices as we develop our service. This document will be
                        updated as our service evolves.
                    </p>
                </div>
                ...
                <section className="mb-8">
                    ...
                    <p className="text-neutral-700 mb-4">
                        During this proof of concept phase, we may collect the following types of information:
                    </p>
                    <ul className="list-disc pl-8 mb-4 text-neutral-700 space-y-2">
                        <li>
                            <strong>Transaction Information:</strong> Details about payments processed through our
                            platform, including amounts, timestamps, and transaction IDs.
                        </li>
                        <li>
                            <strong>Account Information:</strong> Email addresses and other contact information
                ...
                <section className="mb-8">
                    ...
                    <p className="text-neutral-700 mb-4">
                        We use the collected information primarily for the following purposes:
                    </p>
                    <ul className="list-disc pl-8 mb-4 text-neutral-700 space-y-2">
                        <li>To provide and maintain our service</li>
                        <li>To notify you about changes to our service</li>
                        <li>To enable buyer callbacks and email notifications as part of our service</li>
                ...
                <section className="mb-8">
                    ...
                    <p className="text-neutral-700 mb-4">
                        The security of your data is important to us. While we strive to use commercially acceptable
                        means to protect your personal information, please note that during this proof of concept
                        phase, we are still developing our security infrastructure. We recommend not using sensitive
                        or production data during this early testing period.
                    </p>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <p className="text-neutral-700 mb-4">
                        During this development phase, we may use analytics tools to help us measure traffic and
                        usage trends for the service. These tools collect information to help us improve our service.
                    </p>
                </section>
                ...
                <div className="border-t border-neutral-200 pt-6 text-neutral-500 text-sm">
                    ...
                    <p>This privacy policy is for demonstration purposes only as part of a proof of concept.</p>
                </div>
            </div>
            ...
            <footer className="py-6 px-6 md:px-16 bg-neutral-100 text-neutral-800">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="flex justify-center space-x-6 mt-4">
                        <Link href="/">
                            <span className="text-neutral-600 hover:text-black text-sm cursor-pointer">Home</span>
                        </Link>
                    </div>
                </div>
            </footer>
